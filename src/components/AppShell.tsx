...
import { LayoutDashboard, Receipt, Calendar, Repeat, Upload, Settings as SettingsIcon, Eye, EyeOff } from "lucide-react";
...
const tabs = [
  ...
  { to: "/transactions", label: "Tx", icon: Receipt },
  { to: "/calendar", label: "Bills", icon: Calendar },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <header className="sticky top-0 z-30 bg-card/90 backdrop-blur border-b border-border safe-top">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <h1 className="text-lg font-semibold tracking-tight text-primary">Pocket Budget</h1>
          <button
